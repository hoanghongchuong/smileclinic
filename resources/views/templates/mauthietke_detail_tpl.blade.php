    ...
    <div class="container">
        <div class="row detail-row">
            <div class="col-xs-12 col-sm-8 title news-detail-content ">
                ...
                <div class="fb-comments" data-href="{!! asset('chi-tiet-thiet-ke/'.$news_detail->alias.'.html') !!}" data-width="100%" data-num-posts="10"></div>
            </div>
            <div class="col-xs-12 col-sm-4 title">
                ...
                <div class="row news-detail-re-row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4">
                        <a href="{!! asset('chi-tiet-thiet-ke/'.$item->alias.'.html') !!}" title="{!! $item->name !!}"><img src="{!! asset('upload/news/'.$item->photo) !!}" alt="{!! $item->name !!}"  class="img-center"></a>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-8">
                        <h3 class="news-detail-re-tit"><a href="{!! asset('chi-tiet-thiet-ke/'.$item->alias.'.html') !!}" title="{!! $item->name !!}">{!! $item->name !!}</a></h3>
